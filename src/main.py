...
plot = plot_data(ax, "Entries_CC", "CC Entries", process_df(df, "Entries_CC", lag_len_weeks))

ax2 = plt.subplot(gs[1], projection='3d')
plot2 = plot_data(ax2, "Exits_CC", "CC Exits", process_df(df, "Exits_CC", lag_len_weeks))
...
# fig.savefig("test_TN_CC_seasonal.png", dpi=300, transparent=True, bbox_inches='tight')
plt.tight_layout()
plt.show()
